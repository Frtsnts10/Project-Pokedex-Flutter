...
class PokemonDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BlocBuilder<PokemonDetailsCubit, PokemonDetails?>(
          builder: (context, details) {
            return Text(details?.name.toUpperCase() ?? 'Details');
          },
        ),
      ...
      floatingActionButton: BlocBuilder<PokemonDetailsCubit, PokemonDetails?>(
        builder: (context, details) {
          if (details == null) return Container();

          return BlocBuilder<FavoritesCubit, Set<int>>(
            builder: (context, favorites) {
              final isFavorite = favorites.contains(details.id);
